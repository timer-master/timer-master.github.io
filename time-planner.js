...
function newElement() {
  ...
  if (durationInHours > 24) {
    alert(
      "Tasks should generally be completed in less than 24 hours. To set long-term tasks, use our To Do feature."
    );
    return;
  }

  // Convert the times to 12-hour format
  var taskStart12Hour = convertTo12HourFormat(
    startDateTime.toTimeString().slice(0, 5)
  );
  var taskEnd12Hour = convertTo12HourFormat(
  ...
  function timer() {
    ...
    function submitTime() {
      // Get values from input
        var hours =
          parseInt(document.getElementById("inputBoxHours").value) || 0;
        var minutes =
          parseInt(document.getElementById("inputBoxMinutes").value) || 0;
        var seconds =
          parseInt(document.getElementById("inputBoxSeconds").value) || 0;
